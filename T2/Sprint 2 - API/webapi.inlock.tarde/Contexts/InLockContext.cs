...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=NOTE11-S13; initial catalog=inlock_games_dbfirst_tarde; User Id = sa; Pwd = Senai@134; TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => e.IdEstudio).HasName("PK__Estudio__0C3B435550032AE0");
        ...
        {
            entity.HasKey(e => e.IdJogo).HasName("PK__Jogo__69E0851390259260");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TiposUsu__CA04062B223DA9A7");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97B2EABACA");
