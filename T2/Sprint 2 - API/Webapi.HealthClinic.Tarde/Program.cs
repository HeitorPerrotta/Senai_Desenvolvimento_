...
.AddJwtBearer("JwtBearer", options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes("projeto-health_clinic-webapi-chave-autenticacao-dev")),
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Version = "v1",
        Title = "API Webapi.HealthClinic.Tarde",
