...
//habilita o serviço de moderador de conteúdo
builder.Services.AddSingleton(provider => new ContentModeratorClient(
    new ApiKeyServiceClientCredentials("721d0ab88cac47e5aae94a61590b210f"))
    {
        Endpoint = "https://eventcontentmoderatorbrasil.cognitiveservices.azure.com/"
    }
    );
